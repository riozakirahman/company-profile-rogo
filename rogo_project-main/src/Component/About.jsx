  ...
  return (
    <main className="about">
      <section className="intro">
        <div className="intro__brief animate__animated animate__bounceInLeft ">
          <h1 className="intro__title">Company profile that reflects your brand identity</h1>
          <div className="intro__links ">
            <a href="" className="intro__link ">
              Our Services
            </a>
            <FiArrowLeft className="intro__icon animate__animated animate__bounceInRight " />
          </div>
        </div>
        <div className="intro__img-container animate__animated animate__bounceInRight ">
      ...
      <section className="porto">
        <h2 className="section__title">The perfect Agency to boost your company identity</h2>
        <div className="section__images">
